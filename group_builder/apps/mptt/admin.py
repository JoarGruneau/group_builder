...
from group_builder.apps.mptt.compat import remote_field, remote_model
from group_builder.apps.mptt.exceptions import InvalidMove
from group_builder.apps.mptt.forms import MPTTAdminForm, TreeNodeChoiceField
...
class TreeRelatedFieldListFilter(RelatedFieldListFilter):
    ...
    from group_builder.apps.mptt.admin import TreeRelatedFieldListFilter
