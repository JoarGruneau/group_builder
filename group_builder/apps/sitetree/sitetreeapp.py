...
def register_items_hook(func):
    ...
    Example::
        ...
        from group_builder.apps.sitetree.sitetreeapp import register_items_hook
...
def register_i18n_trees(aliases):
    ...
    Example::
        ...
        # First import the register function.
        from group_builder.apps.sitetree.sitetreeapp import register_i18n_trees
...
class SiteTree(object):
    ...
    def get_current_page_title(self, tree_alias, context):
        """Returns resolved from group_builder.apps.sitetree title for current page.
