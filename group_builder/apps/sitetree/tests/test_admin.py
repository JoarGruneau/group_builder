...
def get_item_admin():
    ...
    from group_builder.apps.sitetree.admin import TreeItemAdmin
...
def test_admin_tree_item_move(mock_request, common_tree):
    from group_builder.apps.sitetree.models import TreeItem, Tree
...
@pytest.mark.django_db
def test_admin_tree():
    from group_builder.apps.sitetree.admin import TreeAdmin
...
def test_redirects_handler(mock_request):
    from group_builder.apps.sitetree.admin import redirects_handler
