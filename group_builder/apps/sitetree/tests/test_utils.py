...
def test_import():
    ...
    from group_builder.apps.sitetree.utils import import_project_sitetree_modules
...
def test_get_app_n_model():
    ...
    from group_builder.apps.sitetree.utils import get_app_n_model
...
def test_import_app_sitetree_module():
    ...
    from group_builder.apps.sitetree.utils import import_app_sitetree_module
...
def test_import_project_sitetree_modules():
    ...
    from group_builder.apps.sitetree import settings
    from group_builder.apps.sitetree.models import Tree
    from group_builder.apps.sitetree.utils import get_model_class
...
class TestPermissions():
    ...
    def test_permission_any(self):
        from group_builder.apps.sitetree.toolbox import item
