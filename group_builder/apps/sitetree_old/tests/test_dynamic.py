...
def test_dynamic_basic(render_template_tag, mock_template_context):
    ...
    from group_builder.apps.sitetree.toolbox import compose_dynamic_tree, register_dynamic_trees, tree, item, get_dynamic_trees
    from group_builder.apps.sitetree.sitetreeapp import _IDX_ORPHAN_TREES
    ...
    from group_builder.apps.sitetree.sitetreeapp import _DYNAMIC_TREES
...
def test_dynamic_attach(render_template_tag, mock_template_context, common_tree):
    ...
    from group_builder.apps.sitetree.toolbox import compose_dynamic_tree, register_dynamic_trees, tree, item
...
def test_dynamic_attach_from_module(render_template_tag, mock_template_context, settings):
    ...
    from group_builder.apps.sitetree.toolbox import compose_dynamic_tree, register_dynamic_trees
