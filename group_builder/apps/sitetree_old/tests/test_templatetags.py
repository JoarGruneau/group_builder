...
from group_builder.apps.sitetree.exceptions import SiteTreeError
from group_builder.apps.sitetree.settings import ALIAS_THIS_ANCESTOR_CHILDREN, ALIAS_THIS_CHILDREN, ALIAS_THIS_PARENT_SIBLINGS, \
...
def test_items_hook(render_template_tag, mock_template_context, common_tree):
    ...
    from group_builder.apps.sitetree.toolbox import register_items_hook
...
def test_i18n(build_tree, render_template_tag, mock_template_context):
    ...
    from group_builder.apps.sitetree.toolbox import register_i18n_trees
...
def test_permissions(admin_user, build_tree, render_template_tag, mock_template_context):
    ...
    from group_builder.apps.sitetree.models import TreeItem
